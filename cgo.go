...
#cgo linux LDFLAGS: -L${SRCDIR}/deps/linux/lib -L${SRCDIR}/deps/linux/share/OpenCV/3rdparty/lib -lswscale -lbz2 -lz -lopencv_core -lopencv_imgcodecs -lopencv_imgproc -lippicv -ljpeg -lpng -lz -lgif
void dummy() {}
*/
import "C"
